...
def audit_keel_file(
    ...
    *,
    ...
    if save:
        if out_dir is None:
            out_dir = os.path.join(folder, "_audit")
        out_path = os.path.join(out_dir, "files", f"{basename}.audit.json")
...
def audit_keel_folder(
    ...
    *,
    ...
    if save:
        if out_dir is None:
            out_dir = os.path.join(abs_folder, "_audit")
        out_path = os.path.join(out_dir, "folder.audit.json")
        result["saved_to"] = _save_json(out_path, result)
...
def audit_keel_root(
    ...
    *,
    ...
    if save:
        out_path = os.path.join(out_dir, "root.audit.json")
        result["saved_to"] = _save_json(out_path, result)
